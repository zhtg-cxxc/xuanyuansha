	...
	return {
		...
		start:function(){
			...
			if(!lib.config.new_tutorial){
				...
				var step1=function(){
					ui.create.dialog('欢迎来到轩辕杀，是否进入新手向导？');
				...
				var step5=function(){
					clear();
					ui.create.dialog('如果还有其它问题，欢迎来到种花兔的博客（zhtg.red）交流！<br/><small>（<b>该项目基于开源项目无名杀编写，无名杀以及该项目轩辕杀均出于非营利目的编写，遵循<a href="LICENSE">GNU协议</a></b>，所以找拓展的话也可以去百度无名杀吧或者无名杀相关群看看哦）</small>');
